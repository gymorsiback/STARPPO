...
def get_latest_n_runs(n=5):
    logs_dir = '/root/autodl-tmp/MOE111/results/PPO_GNN/logs'
...
def plot_aggregated_curves(run_dirs, output_dir):
    ...
    window_latency = max(20, min_len // 100)  
    ...
    l_sem = smooth(l_sem, window_latency) * 0.20  
...
if __name__ == '__main__':
    ...
    output_dir = '/root/autodl-tmp/MOE111/results/PPO_GNN/logs'
