...
class GNNEncoder(nn.Module):
    def __init__(self, node_dim, hidden_dim, edge_dim=1, num_layers=2):
        ...
        self.convs.append(GINEConv(
            ...
            train_eps=True,
            edge_dim=edge_dim  # Specify edge feature dimension
        ))
...
class GNNActorCritic(nn.Module):
    def __init__(self,
        ...
        # Input: GNN_embed + global_feat + original_node_feat
    ...
    def _manual_pool(self, node_embeds, num_graphs, num_nodes_per_graph):
        """Manual pooling to avoid torch_scatter CUDA compatibility issues."""
    ...
    def forward(self, batch_data):
        ...
        # Save original node features for skip connection
        ...
        # Actor: Node Logits with SKIP CONNECTION
