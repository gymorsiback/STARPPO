...
def plot_single_run(log_dir, run_id=None):
    ...
    x = np.arange(1, len(latency) + 1)  # Epochs start from 1
    ...
    # ========================================
    # Figure: Latency & Cost (Same as PFAPPO)
    # ========================================
    ...
    ax1.plot(x, latency, color=color_lat, linewidth=0.5, alpha=0.3)  # Raw data
    ...
    ax2.plot(x, cost, color=color_cost, linewidth=0.5, alpha=0.3)  # Raw data
