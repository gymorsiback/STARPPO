...
def plot_batch_results(log_dir, n_runs=5):
    """
    Plots aggregated training results from multiple runs.
    Only draws: Latency & Cost (same style as PFAPPO)
    """
    ...
    # Sort by modification time and take latest n
    ...
    # Filter extreme outliers in cost (same as PFAPPO)
    cost_threshold = 0.20
    ...
    # Use epoch as x-axis (simpler and clearer for supervised learning)
    x = np.arange(1, min_len + 1)  # Epochs
    ...
    # ========================================
    # Figure: Latency & Cost (Same as PFAPPO Figure C)
    # ========================================
    ...
    # Save (only timestamped version, no overwrite)
